    ...
    <div class="container">
        ...
        <form class="new-feedback" @submit.prevent="submitted">
            ...
            <div class="feedback-headline">
                ...
                <label for="headline" class="headline-para">Add a short, descriptive headline</label>
                <input type="text" id="headline" v-model="headline">
            </div>
            <div class="feedback-category">
                <h4 class="category-title">Category</h4>
                <p class="category-para">Choose a category for your feedback</p>
                <select name="category-select" class="category-select" v-model="category">
            ...
            <div class="feedback-detail">
                ...
                <label for="detail" class="detail-para">Include any specific comments on what should be improved, added, etc.</label>
                <textarea name="details" id="details" rows="10" v-model="comment"></textarea>
            </div>
